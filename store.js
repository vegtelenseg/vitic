...
module.exports = {
  ...
  standOptions() {
    return [
      {
        option: new StandOption('Grand Stand (R100)', this.orderSelectionNode(), 100)
      },
      {
        option: new StandOption('East Stand (R80)', this.orderSelectionNode(), 80)
      },
      {
        option: new StandOption('Party Stand (R150)', this.orderSelectionNode(), 150)
      },
      {
        option: new StandOption('Family Stand (R50)', this.orderSelectionNode(), 50)
      },
      {
